    ...
    <script>
      document.addEventListener('DOMContentLoaded', () => {
        ...
        if (sections.length > 0) {
            ...
            navWrapper.className = "sticky top-0 z-[100] bg-slate-50/95 backdrop-blur-md pb-4 pt-4 -mx-4 px-4 md:-mx-6 md:px-6 lg:-mx-8 lg:px-8 border-b border-slate-200/60 shadow-sm flex items-center gap-2 overflow-x-auto print:hidden";
